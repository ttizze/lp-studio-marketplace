...
- the current `design-dna.md` or equivalent confirmed design DNA
...
5. Fix obvious layout, overlap, clipping, and text-fit issues.
6. Keep the server running only if the user should try the result locally.
